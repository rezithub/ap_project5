CXX= g++ -g -std=c++20
FILES = sources/main.o sources/admin.o sources/CasualMatch.o sources/commandhandler.o sources/exceptions.o sources/game.o sources/invitation.o sources/matchplayer.o sources/player.o sources/report.o sources/user.o
EXE= UTGame
...
$(EXE) : $(FILES)
	$(CXX) $^ -o $@
game.o : sources/game.cpp sources/game.hpp sources/user.hpp sources/player.hpp sources/admin.hpp sources/CasualMatch.hpp sources/invitation.hpp sources/report.hpp sources/exceptions.hpp sources/constants.hpp
	$(CXX) -c $< -o $@
...
user.o : sources/user.cpp sources/user.hpp sources/invitation.hpp sources/exceptions.hpp
	$(CXX) -c $< -o $@
CasualMatch.o : sources/CasualMatch.cpp sources/CasualMatch.hpp sources/matchplayer.hpp sources/exceptions.hpp sources/constants.hpp
	$(CXX) -c $< -o $@
