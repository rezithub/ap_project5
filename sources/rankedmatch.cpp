...
rankedmatch::rankedmatch(User *p1, User *p2) 
    : match(p1, p2, 
            INTIAL_RN_HEALTH - p1->get_health_penalty_amount(), 
            INTIAL_RN_BULLET - p1->get_bullet_penalty_amount(), 
            INTIAL_RN_BULLET - p2->get_health_penalty_amount(), 
            INTIAL_RN_BULLET - p2->get_bullet_penalty_amount()) 
{
